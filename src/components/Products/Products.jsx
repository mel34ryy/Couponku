  ...
  return (
    ...
    <section>
     ...
     <div className={`${styles.header} py-5`}>
      ...
      <p>Dive into our gallery of exclusive discounts and find the perfect products at the best prices</p>
     </div>
     ...
     <div className={`${styles.categories} py-5`}>
      ...
      <div className={`${styles.cards_container} col-12 d-flex flex-wrap mx-auto gap-1 gap-lg-1 justify-content-center`}>

        <div className={`${styles.cat_card} col-10 col-sm-5 col-lg-3 rounded-3 p-3 px-6 m-4 d-flex`}>
     ...
     <div className={`${styles.top_products} py-5 text-center`}>
      <p>Check out our top-selling items that customers cannot get enough of</p>
      <h4>Top-Selling Products</h4>

      <div className={`${styles.products_info} d-flex col-11 justify-content-center mx-auto my-4 pt-5 flex-wrap gap-5`}>
        <div className={`${styles.product1} col-lg-3 col-10 col-md-7 mb-5`}>
          ...
          <p>Explore a range of gadgets that are trending and in high demand.</p>
        </div>
        ...
        <div className={`${styles.product3} col-lg-3 col-10 col-md-7 mb-5`}>
          ...
          <p>Shop must-have home essentials that combine style and functionality.</p>
        </div>
      </div>

      <div className={`${styles.exclusive} py-5 col-12 text-center d-flex flex-wrap justify-content-around  `}>

        <div className={`${styles.offer} col-lg-8 col-xl-5 col-10 ps-lg-4  text-center mb-4`}>
          ...
          <div className={`${styles.credits} mt-5 text-start ms-2 ps-md-5`}>
            <p> <i className="fa-solid fa-check me-1"></i> Weekly Discounts on Popular Items</p>
            <p> <i className="fa-solid fa-check me-1"></i> Early Access to Sales</p>
            <p> <i className="fa-solid fa-check me-1"></i> Special Member-Only Coupons</p>
            <div className={`${styles.btns} col-12 col-md-10`}>
              ...
              <button className={`${styles.btn2} btn  px-1 mx-2 mt-5 col-5`}>
     ...
     <div className={`${styles.comments} py-5 d-flex flex-column align-items-center`}>

      <div className={`${styles.comment} d-flex mt-5 col-md-6 col-11 pb-5`}>

        <div className={`${styles.commentImg} mx-4`}>
          <img src={commentImg1} alt="comment_img" className={`${styles.commentImg} rounded-circle`} />
        </div>
        ...
        <div className={`${styles.commentDet}`}>
          ...
          <p>Amazing deals and fantastic customer service. Highly recommend!</p>
      ...
      <div className={`${styles.comment} d-flex mt-5 col-md-6 col-11 pb-5`}>
        ...
        <div className={`${styles.commentImg} mx-4`}>
          <img src={commentImg2} alt="comment_img" className={`${styles.commentImg} rounded-circle`} />
        </div>
        ...
        <div className={`${styles.commentDet}`}>
          ...
          <p>The discounts are unbeatable, and the product range is vast.</p>
          <div className={`${styles.author}`}>Samantha Lee</div>
          <div className={`${styles.commentDate}`}>September 20, 2023</div>
        </div>

      </div>
      <div className={`${styles.comment} d-flex mt-5 col-md-6 col-11 pb-5 border-0`}>

        <div className={`${styles.commentImg} mx-4`}>
          <img src={commentImg3} alt="comment_img" className={`${styles.commentImg} rounded-circle`} />
        </div>
     ...
     <div className={`${styles.questions} d-flex justify-content-around col-11 py-5 mx-auto flex-wrap`}>


        <div className={`${styles.questionsHead} col-12 col-md-6`}>
          <p className={`${styles.faq}`}>FAQ</p>
          <h2>Your Questions Answered</h2>
          <p>Find out more about our amazing deals and shopping experience.</p>
        </div>

        <div className={`${styles.questionsCards} col-12 col-md-6 `}>
          <div className={`${styles.questionCard} col-12 p-3 mb-4 rounded-2 pt-4 mx-auto`}>
            <h6>How do I use a coupon code?</h6>
            <p>Simply enter the coupon code at checkout to enjoy your discount.</p>
          </div>
          <div className={`${styles.questionCard} col-12 p-3 mb-4 rounded-2 pt-4 mx-auto`}>
            <h6>What is your return policy?</h6>
            <p>We offer a 30-day return policy for most products. Visit our returns page for more details.</p>
          </div>
          <div className={`${styles.questionCard} col-12 p-3 mb-4 rounded-2 pt-4 mx-auto`}>
            <h6>How can I track my order?</h6>
            <p>You can track your order through your account dashboard or the tracking link sent to your email.</p>
          </div>
        </div>
